...
export const Route = createFileRoute("/laboratorio")({
  head: () =>
    seo({
      title: "Laboratório — experimentos de programação · Henrique Kenzo",
      description:
        "Experimentos reais de desenvolvimento: scanner de portas em Python (BillsMap), bots, mini-CRM com Google Sheets API e exercícios avançados de React.",
      path: "/laboratorio",
    }),
  component: LabPage,
});
...
const experiments = [
  {
    id: "EXP_01",
    title: "BillsMap Scanner",
    desc: "Scanner de portas assíncrono construído em Python. Estudo prático de redes e da biblioteca Asyncio.",
    tag: "Python & Redes",
    progress: 95,
  },
  {
    id: "EXP_02",
    title: "Bot de Música",
    desc: "Bot para Discord em Python focado em manipulação de áudio e comandos assíncronos.",
    tag: "Python",
    progress: 80,
  },
  {
    id: "EXP_03",
    title: "Mini-CRM CLI",
    desc: "Integração via API com o Google Sheets para gerenciar contatos através de terminal.",
    tag: "APIs & Integração",
    progress: 100,
  },
  {
    ...
    desc: "Múltiplos componentes isolados focando em Hooks e gerenciamento de estado complexo.",
    tag: "React",
    progress: 60,
  },
];
              ...
              <Reveal>
                ...
                <div className="flex items-end justify-between flex-wrap gap-6">
                  <h1 className="font-display text-5xl md:text-7xl max-w-3xl text-balance">
                    O que estudo quando
                    <br />
                    <span className="text-accent italic">ninguém está olhando.</span>
                  </h1>
