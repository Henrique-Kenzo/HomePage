            ...
            <div className="mx-auto max-w-7xl">
              <Reveal>
                ...
                <p className="mt-8 max-w-2xl text-lg text-muted-foreground">
                  Cada projeto resolve um problema real, com decisões técnicas explícitas e métricas que
                  importam.
                </p>
              </Reveal>
            </div>
                ...
                <Reveal key={p.slug} delay={i * 0.05}>
                  ...
                  >
                    <div className="grid gap-8 md:grid-cols-12 md:items-center">
                      ...
                      <div className="md:col-span-1 text-right font-mono text-xl text-muted-foreground group-hover:text-primary group-hover:translate-x-1 transition-all">
                        →
                      </div>
                    </div>
                  </Link>
